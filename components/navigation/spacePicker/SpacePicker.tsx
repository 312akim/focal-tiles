...
const SpacePicker: React.FC<ISpacePicker> = ({ spaces }) => {
  ...
  return (
    <div className='flex-col mx-auto my-auto hover:cursor-pointer' tabIndex={0} onFocus={() => setHidden(false)} onBlur={() => setHidden(true)}>
      <div className='flex'>
        <h2 className='my-auto px-1 text-lg'>Space Picker</h2>
        <FontAwesomeIcon icon={faAngleDown} className='my-auto pl-1' size='lg'/>
      </div>
      {/* The below is not rendering correctly */}
      <div>
